...
mod app {
    ...
    type Timer = MonotonicTimer<hal::pac::TIMER0>;
    ...
    fn init(ctx: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        let mono = MonotonicTimer::new(ctx.device.TIMER0);//, 64_000_000);
    ...
    fn on_gpiote(mut ctx: on_gpiote::Context) {
        ...
        // Debounce
        debounce::spawn_after(ExtU32::millis(50)).ok();
    }
