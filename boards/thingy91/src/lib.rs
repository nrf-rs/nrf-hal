//! Board support crate for the Nordic Thingy:91
//!
//! See https://www.nordicsemi.com/Software-and-tools/Prototyping-platforms/Nordic-Thingy-91
//!
//! User Manual: https://infocenter.nordicsemi.com/pdf/Thingy91_UG_v1.3.pdf
//!
#![no_std]
...
///
/// * SPI
///    * ADXL362 Accelerometer (CS=P0.08, INT=P0.09)
///    * ADXL372 Accelerometer (CS=P0.07, INT=P0.06)
/// * I²C
///    * Bosch BME680 Gas, Temperature, Pressure and Humidity Sensor
///    * Rohm BH1749 Colour Sensor
#[allow(non_snake_case)]
pub struct Board {
    /// The nRF9160's pins which are not otherwise occupied on the Thingy:91
    pub pins: Pins,

    /// The first UART which is wired to the nRF52840
    pub uart0: Uarte<pac::UARTE0_NS>,

    /// The second UART which is wired to nRF52840
    pub uart1: Uarte<pac::UARTE1_NS>,
...
impl Board {
    ...
    fn new(cp: CorePeripherals, p: Peripherals) -> Self {
        ...
        // The Thingy:91 features two USB CDC ports on the nRF52840.
        // The first runs at 115_200 bps.
        let uart0 = Uarte::new(
            p.UARTE0_NS,
            uarte::Pins {
        ...
        // The Thingy:91 features two USB CDC ports on the nRF52840.
        // The first runs at 1_000_000 bps
        let uart1 = Uarte::new(
            p.UARTE1_NS,
            uarte::Pins {
                txd: pins0.p0_22.into_push_pull_output(Level::High).degrade(),
                rxd: pins0.p0_23.into_floating_input().degrade(),
                rts: Some(pins0.p0_24.into_push_pull_output(Level::High).degrade()),
        ...
        Board {
            ...
            pins: Pins {
                // 0, 1 and 2 are Colour Sensor LEDs
                P0_03: pins0.p0_03,
                P0_04: pins0.p0_04,
                P0_05: pins0.p0_05,
                P0_06: pins0.p0_06,
            ...
            leds: Leds {
                sense_red: Led::new(pins0.p0_00.degrade()),
                sense_green: Led::new(pins0.p0_01.degrade()),
                sense_blue: Led::new(pins0.p0_02.degrade()),
                red: Led::new(pins0.p0_29.degrade()),
                green: Led::new(pins0.p0_30.degrade()),
                blue: Led::new(pins0.p0_31.degrade()),
            },

            buttons: Buttons {
                sw0: Button::new(pins0.p0_26.degrade()),
            },
...
/// The nRF9160 pins that are available on the Thingy91
#[allow(non_snake_case)]
pub struct Pins {
    /// SPI SCK
...
/// The LEDs on the Thingy:91 board
pub struct Leds {
    /// Thingy:91: Colour Sensor LED 1, nRF9160: P0.00
    pub sense_red: Led,

    /// Thingy:91: Colour Sensor LED 2, nRF9160: P0.01
    pub sense_green: Led,

    /// Thingy:91: Colour Sensor LED 3, nRF9160: P0.02
    pub sense_blue: Led,

    /// Thingy:91: Light Well LED 1, nRF9160: P0.29
    pub red: Led,

    /// Thingy:91: Light Well LED 2, nRF9160: P0.30
    pub green: Led,

    /// Thingy:91: Light Well LED 3, nRF9160: P0.31
    pub blue: Led,
}
...
/// The Buttons on the Thingy:91 board
pub struct Buttons {
    /// Thingy:91: Button SW0, nRF9160: P0.26
    pub sw0: Button,
}
