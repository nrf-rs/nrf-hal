...
//   `rg 'type EVENTS_.*crate::Reg' --type rust --no-heading --no-line-number`
// Find (regex):
//   `^src/(.*)\.rs:pub type (.*) = .*$`
// Replace (regex):
...
impl Event for crate::pac::spi1::EVENTS_READY {}
...
impl Event for crate::pac::spim1::EVENTS_STOPPED {}
impl Event for crate::pac::spim1::EVENTS_ENDRX {}
impl Event for crate::pac::spim1::EVENTS_END {}
impl Event for crate::pac::spim1::EVENTS_ENDTX {}
impl Event for crate::pac::spim1::EVENTS_STARTED {}
